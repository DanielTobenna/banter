# Generated by Django 3.2 on 2021-08-19 02:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='banterapp.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Invoice',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='banterapp.product')),
            ],
        ),
        migrations.CreateModel(
            name='Investment',
            fields=[
                ...
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='banterapp.customer')),
            ],
        ),
    ]
